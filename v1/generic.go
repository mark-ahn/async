...
//go:generate genny -in some_other__impl__template.go -out some_other__impl__template__gen.go gen "Some=BUILTINS,Bytes,interface{} Other=BUILTINS,Bytes,interface{}"
